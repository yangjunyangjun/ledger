...
func QueryRevenue(userId int64, startTime, endTime string, tType int64) (incomeType []*db.Revenue, err error) {
	return _db.QueryRevenue(userId, startTime, endTime, tType)
}
